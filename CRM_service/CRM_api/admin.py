...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'device', 'customers', 'order_description', 'created_at', 'last_updated_at', 'order_status')

class CustomerAdmin(admin.ModelAdmin):
    list_display = ('id', 'customer_name', 'customer_address', 'customer_city')

class DeviceInFieldAdmin(admin.ModelAdmin):
    list_display = ('id', 'serial_number', 'customers_id', 'analyzer_id', 'owner_status')
