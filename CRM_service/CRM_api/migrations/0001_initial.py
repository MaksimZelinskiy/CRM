    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analyzer_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='CRM_api.device', verbose_name='Идентификатор оборудования')),
                ('customers_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='CRM_api.customer', verbose_name='Идентификатор контрагента')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated_at', models.DateTimeField(blank=True, null=True, verbose_name='Последние изменение')),
                ('order_status', models.TextField(validators=[CRM_api.models.status_validator], verbose_name='Статус заявки')),
                ('customers', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='CRM_api.customer', verbose_name='Конечный пользователь')),
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='CRM_api.deviceinfield', verbose_name='Оборудование')),
            ],
            options={
                'verbose_name': 'Заявка',
